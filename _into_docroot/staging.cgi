#!/virtual/warzone/py-venv/warzone/bin/python
# encoding: utf-8
...
sys.path.append("/virtual/warzone/py-venv/warzone/lib/python3.6/site-packages")
sys.path.append("/virtual/warzone/src-staging/warzone_aoc/web")
...
def run_with_cgi(application):
    ...
    # customized これがないとどうなるのか見ないといけない
    # 元のenvironにPATH_INFOはない
    # このPATHはURLの話
